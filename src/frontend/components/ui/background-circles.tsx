...
const AnimatedGrid = () => (
    ...
    >
        <div className="h-full w-full [background-image:repeating-linear-gradient(100deg,#94a3b8_0%,#94a3b8_1px,transparent_1px,transparent_4%)] opacity-50" />
    </motion.div>
);

export function BackgroundCircles({
    title = "StudyVerse",
    description = "The ultimate learning platform for modern students",
    className,
    variant = "octonary",
